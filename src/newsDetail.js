        ...
        return (
            <div className="news">
                ...
                <div className='img-wrap'>
                    <img src="http://img1.gtimg.com/15/1580/158031/15803178_1200x1000_0.jpg"/>
                </div>
                <div className="news-body">{this.props.body}</div>
            </div>
        )
    }
})
var NewsDetail=React.createClass({
    render:function(){
        var newsNode=this.props.content.map(function(news,index){
            return <News key={'news-'+index} title={news.title} url={news.url} body={news.body}></News>
        });
        return (
            <div>
            {newsNode}
...
var CommentBox=React.createClass({
    ...
    render:function(){
        return (
            ...
            <a className="commentPage" href={this.props.commentUrl}>评论页</a>
        </div>
        );
    }
});
ReactDOM.render(
<CommentBox url="comments.json" newsurl="newsDetail.json" commentUrl="../newsComment/newsComment.html"/>,
