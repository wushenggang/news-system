...
var loadMoreLimitNum=3;//最多可以加载新闻的次数
var num=5
                ...
                <ul>
                    {
                        data.map(function(content,index){
                            return <div className="content-box clearfix">
                                <a href={newsDetailUrl[index].url}>
                                <img src={content.url} alt="" className="content-pic"/>
...
ReactDOM.render(
    <App url="newsList.json" linkUrl="newsDetailUrl.json"/>,
